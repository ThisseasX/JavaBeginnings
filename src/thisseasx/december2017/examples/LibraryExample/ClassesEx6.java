...
public class ClassesEx6 {
    ...
    public static void main(String[] args) {
        ...
        /**
         * Assign the book collection to the LibraryExample
         */
...
//
//        LibraryExample.printAvailableBooks();
//        LibraryExample.printBookDetails(book16);
//        LibraryExample.printBooksFromAuthor(lisa);
//        LibraryExample.printTheMostPopularBook();
    }
